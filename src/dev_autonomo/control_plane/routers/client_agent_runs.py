"""Router GET /clients/{cid}/agents/{aid}/runs.

Lista as execuções (runs) de um agente específico, paginadas.
...
from dev_autonomo.control_plane.schemas.agent_runs import AgentRunsPage
...
async def list_agent_runs_endpoint(
    ...
    # Garante que o client autenticado tem permissão sobre o cid da URL
    if client.id != cid:
        raise HTTPException(
